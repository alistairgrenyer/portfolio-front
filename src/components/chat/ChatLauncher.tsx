...
export default function ChatLauncher({ isOpen, onClick }: ChatLauncherProps) {
  ...
  return (
    <button
      onClick={onClick}
      className={`fixed bottom-6 right-6 w-14 h-14 rounded-full bg-accent dark:bg-accent-dark hover:bg-opacity-30 dark:hover:bg-opacity-90 text-background dark:text-background-dark flex items-center justify-center shadow-lg transition-all duration-300 z-40 focus:outline-none focus:ring-2 focus:ring-accent dark:focus:ring-accent-dark focus:ring-offset-2 ${
