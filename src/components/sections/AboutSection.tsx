  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-900">
      <div className="container-tight">
        <h2 className="text-3xl md:text-4xl font-bold mb-10 text-center text-gray-900 dark:text-white">About Me</h2>
        ...
        <div className="max-w-3xl mx-auto">
          {loading ? (
            <div className="animate-pulse space-y-4">
              ...
              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md w-full mb-3"></div>
              <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md w-5/6 mb-3"></div>
            ...
            <>
              <div className="prose lg:prose-lg dark:prose-invert max-w-none">
                <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-6 leading-relaxed text-balance">
                  {profile?.basics.summary}
                </p>
                <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 italic leading-relaxed text-balance">
              ...
              {profile?.basics.location && (
                <div className="mt-10 flex items-center justify-center">
                  <div className="text-gray-600 dark:text-gray-400 flex items-center bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-full shadow-sm">
