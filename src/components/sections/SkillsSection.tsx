  ...
  return (
    <section id="skills" data-aos="fade-up" className="py-20 bg-background dark:bg-background-dark">
      <div className="container-tight">
        <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-10 text-center text-primary dark:text-primary-dark">Skills</h2>
        
        {loading ? (
          <div className="animate-pulse bg-surface dark:bg-surface-dark p-6 rounded-xl shadow-md border border-surface dark:border-surface-dark min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
          ...
          <div className="bg-surface dark:bg-surface-dark p-6 md:p-8 rounded-xl shadow-md border border-surface dark:border-surface-dark hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="h-[50vh] min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
              <NeovisGraph />
            </div>
          </div>
        )}
