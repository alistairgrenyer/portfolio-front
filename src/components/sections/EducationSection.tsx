    ...
    <section id="education" className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-10">
          {/* Education */}
          <div>
            <h3 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">Education</h3>
          ...
          {/* Certifications */}
          <div>
            <h3 className="text-2xl font-semibold mb-6 text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700 pb-2">Certifications</h3>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {profile.certifications.map((cert, index) => (
                  <div key={index} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 shadow-sm flex items-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">No certification data available.</p>
            )}
          </div>
        </div>
      </div>
